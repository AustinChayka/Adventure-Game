public class EnemyBullet extends GameObject {
    ...
    private Light light = new Light(10, 0xffff0000);
    
    private int bounces = 0;
    private static int maxBounces = 1;
    
    public EnemyBullet(float x, float y, int dir) {
    ...
    public void render(Container c, Renderer r) {
        ...
        r.fillRect((int)x, (int)y, 1, 1, 0xffff0000, 0);
