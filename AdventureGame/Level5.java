...
public class Level5 extends Level {
    ...
    private String[] playerDialog = {"I think I can smell fresh air", "this must be the way out"};
    private double dialogTimer = 2f;
    private int dialogIndex = 0;
    
    public Level5() {
        
        this.stateName = "level5";
        loadLevel("Res/Levels/Level5.png", "level6");
        
        camera = new Camera("player");
        
        level.setLightBlock(Light.FULL);
        
        objects.add(new LockDoor(16, 6, this, "Strange"));
    ...
    public void init(Container c) {
        ...
        c.getGUI().showTitleText("Tunnels");
